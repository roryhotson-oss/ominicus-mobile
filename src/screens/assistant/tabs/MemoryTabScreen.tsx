...
import { MemoryTabContent } from '@/componentsV2/features/Assistant/MemoryTabContent'
import { useAssistant } from '@/hooks/useAssistant'
import type { AssistantDetailTabParamList } from '@/navigators/AssistantDetailTabNavigator'

type MemoryTabRouteProp = RouteProp<AssistantDetailTabParamList, 'MemoryTab'>

export default function MemoryTabScreen() {
  const route = useRoute<MemoryTabRouteProp>()
  ...
  return (
    <KeyboardAwareScrollView
      ...
      <YStack className="flex-1 bg-transparent pt-2.5">
        <MemoryTabContent assistant={assistant} updateAssistant={updateAssistant} />
      </YStack>
    </KeyboardAwareScrollView>
  )
}
